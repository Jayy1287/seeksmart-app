  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      {categories.map((category) => (
        <Link
          className="flex min-h-16 flex-col justify-center rounded-md border border-line px-4 py-3 text-sm font-medium transition hover:border-accent hover:text-accent"
